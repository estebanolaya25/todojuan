...
using todojuan.common.Responses;
...
namespace todojuan.Functions.Functions
{
    ...
    [Table("todo","Todo","{id}" ,Connection = "AzureWebJobsStorage")] TodoEntity todoEntity,string id,
    ILogger log)
        {
   ...
   [Table("todo", Connection = "AzureWebJobsStorage")] CloudTable todoTable, string id,
   ILogger log)
        {
